 ...
 * hieu.lai@exoplatform.com 7 Jun 2011
 */
public class BookStoreServiceImpl implements BookStoreService
{
   ...
   public BookStoreServiceImpl(RepositoryService rservice, CacheService cacheService)
   {
   ...
   {
      jcrDataStorage.init();
      System.out.println("test BookStoreService is started or not");
   }
