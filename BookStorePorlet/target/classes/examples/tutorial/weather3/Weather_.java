...
private static final ControllerMethod method_0 = new ControllerMethod(null,Phase.RENDER,examples.tutorial.weather3.Weather.class,Tools.safeGetMethod(examples.tutorial.weather3.Weather.class,"index"), Arrays.<ControllerParameter>asList());
...
public static final ControllerBean DESCRIPTOR = new ControllerBean(Weather.class,Arrays.<ControllerMethod>asList(method_0));
}
